...
class PanelParameters extends PanelAtributesValue {
    ...
    public Recombination<KnapsackIndividual, Knapsack> getRecombinationMethod() {
    ...
    public MutationBinary<KnapsackIndividual, Knapsack> getMutationMethod() {
        double mutationProb = Double.parseDouble(jTextFieldProbMutation.getText());
        return new MutationBinary<>(mutationProb);
    }
